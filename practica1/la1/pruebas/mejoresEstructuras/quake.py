# Generacion del grafico de estudio del error de entrenamiento de la mejor arquitectura quake
...
plt.title("Error de entrenamiento de la mejor arquitectura quake")
plt.legend()
plt.savefig("quake_2,100.png")
