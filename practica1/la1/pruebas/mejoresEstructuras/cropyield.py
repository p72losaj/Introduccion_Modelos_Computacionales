# Generacion del grafico de estudio del error de entrenamiento de la mejor arquitectura cropyiel
...
with open('cropyield_1,8', 'r') as f:
    # Semilla 1
    for line in f:
...
plt.title("Error de entrenamiento de la mejor arquitectura cropyield")
plt.legend()
plt.savefig("cropyield_1,8.png")
