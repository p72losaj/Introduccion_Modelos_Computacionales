# Generacion del grafico de estudio del error de entrenamiento de la mejor arquitectura XOR
...
plt.title("Error de entrenamiento de la mejor arquitectura XOR")
plt.legend()
plt.savefig("xor_2,100.png")
